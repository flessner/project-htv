...
var app = (function () {
    ...
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(34:4) {#each _links as [path, name]}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(div, "class", "nav svelte-1ubnnn4");
    			add_location(div, file$1, 32, 2, 569);
    			attr_dev(aside, "class", "svelte-1ubnnn4");
    			add_location(aside, file$1, 31, 0, 558);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const _links = [["./index", "Home"], ["./modal", "Modal"], ["./reset", "Reset"]];
    	const writable_props = [];
